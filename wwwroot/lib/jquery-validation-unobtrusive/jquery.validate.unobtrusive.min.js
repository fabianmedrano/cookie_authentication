...
!(function (a) {
                    ...
                    options: {
                        ...
                        errorPlacement: function () {
                            !function (a, e) {
                                var e = s(this).find(
                                    ...
                                    n = (n = e.attr("data-valmsg-replace"))
                                        ? !1 !== s.parseJSON(n)
                                        : null;
                                e
                        ...
                        success: function () {
                            !function (a) {
                                ...
                                n &&
                                    ((e = (e = n.attr("data-valmsg-replace"))
                                        ? s.parseJSON(e)
                                        : null),
                                    n
                                        .addClass("field-validation-valid")
    ...
    return (
        ...
        o.methods.extension
            ? (a.addSingleVal("accept", "mimtype"),
              a.addSingleVal("extension", "extension"))
            : a.addSingleVal("extension", "extension", "accept"),
        ...
        a.add("remote", ["url", "type", "additionalfields"], function (t) {
            var i = {
                ...
                r = n(t.element.name);
            s.each(
                (t.params.additionalfields || t.element.name)
                    .replace(/^\s+|\s+$/g, "")
                    .split(/\s*,\s*/g),
                function (a, e) {
                    var n = m(e, r);
        ...
        a.add("password", ["min", "nonalphamin", "regex"], function (a) {
            a.params.min && l(a, "minlength", a.params.min),
                a.params.nonalphamin &&
                    l(a, "nonalphamin", a.params.nonalphamin),
